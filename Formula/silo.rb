...
class Silo < Formula
  ...
  url "https://github.com/rchekalov/silo/releases/download/v0.5.3/silo-0.5.3-macos-arm64.tar.gz"
  sha256 "6a9306a7916ba03f1cb1a2a842280b29150249d7f878b23f1c080b96591f31da"
  license "Apache-2.0"
  version "0.5.3"
